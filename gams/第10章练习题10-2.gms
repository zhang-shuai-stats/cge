$title  第10章练习题10-2  新古典主义宏观闭合 检验价格基准的零次齐次性质

$ontext
设置新古典主义宏观闭合
以劳动价格WL为价格基准，采用加个虚变量Walras而不是删除某一市场等式的方法
检验货币中性和模型对价格的零阶齐次性质。
将劳动价格增加20%，也就是，固定WL.fx = 1.2，而其它价格的初始值不变，仍然为1。
检验是否所有价格最后都增长了20%，而实体经济数量保持不变
$offtext
...
WL.fx=WL0*1.2;
model cgeNeoWLup  /all/;
solve cgeNeoWLup using mcp;
*检验walras是否等于零
display walras.l,WL.l,PA.l,QA.l;
