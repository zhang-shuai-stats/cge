$title  例14.8.1 开放经济的多活动部门多商品部门的CGE模型，凯恩斯闭合
...
parameters
GDPmultiplier    政府开支增加10%对GDP的影响
laborincrease    政府开支增加10%对就业的影响;

gdpmultiplier=(gdp.l-gdp0)/(Eg.l-Eg0);
laborincrease=(QLSAGG.l-QLSAGG0)/QLSAGG0;
display gdpmultiplier,laborincrease;
