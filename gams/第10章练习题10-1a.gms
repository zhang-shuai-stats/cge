...
$ontext
设置新古典主义宏观闭合
方法1，以劳动价格WL为价格基准，固定WL为1, 采用删除劳动力市场等式的方法
$offtext
...
PA(a),PVA(a),PINTA(a),WL,WK,QA(a),QVA(a),QINTA(a),QINT(a,ap),QLD(a),QKD(a),QLS,QKS,YH,QH(a);

*定义等式
equation

QAfn(a),QAFOCeq(a),PAeq(a),QVAfn(a),QVAFOC(a),PVAeq(a),QINTfn(a,ap),PINTAeq(ap),
YHeq,QHeq(a),ComEqui(a),Keq
;
